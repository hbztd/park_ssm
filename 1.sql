...
insert  into `permission`(`id`,`url`,`name`) values (1,'card:add','增加车主'),(2,'card:delete','删除车主'),(3,'card:update','更新车主'),(4,'card:find','查找车主信息'),(5,'fixed:entry','进入停车场'),(6,'fixed:out','退出停车场'),(7,'fixed:delete','删除停车记录'),(8,'fixed:find','查找所有停车记录'),(9,'fixed:findEntry','查找正在停车的记录'),(10,'seat:add','增加车位'),(11,'seat:delete','删除车位'),(12,'seat:update','更新车位'),(13,'seat:find','查找车位信息'),(14,'temp:entry','进入停车场'),(15,'temp:out','退出停车场'),(16,'temp:delete','删除停车记录'),(17,'temp:find','查找所有停车记录');
...
insert  into `u_permission`(`uid`,`pid`) values ('xiaoman',1),('xmadmin',1),('xmadmin',2),('xmadmin',3),('xmadmin',4),('xmadmin',5),('xmadmin',6),('xmadmin',7),('xmadmin',8),('xmadmin',9),('xmadmin',10),('xmadmin',11),('xmadmin',12),('xmadmin',13),('xmadmin',14),('xmadmin',15),('xmadmin',16),('xmadmin',17),('xiaoman',11),('xiaoman',13),('xiaoman',12),('xiaoman',2),('xiaoman',3),('xiaoman',4),('xiaoman',6),('xiaoman',7),('xiaoman',8),('xiaoman',9),('xiaoman',14),('xiaoman',15),('xiaoman',16),('xiaoman',17),('xiaoman',10),('xiaoman',5);
...
insert  into `user`(`account`,`role_id`,`user_name`,`real_name`,`user_pwd`,`user_phone`,`user_status`) values ('xiaoman','r002','小漫','张小漫','E0AF4C33FEFD922030940F83D36FF062','18871012711',0),('xmadmin','r001','admin','马小漫','8897E1574C690AEDE59AC8E24160B73A','18871012111',0);
